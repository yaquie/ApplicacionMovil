...
public class PrimerFragment extends Fragment {
    ...
    private static String TAG = PrimerFragment.class.getSimpleName();
    ...
    public static PrimerFragment newInstance() {
        PrimerFragment f = new PrimerFragment();
        Bundle b = new Bundle();
        f.setArguments(b);
        return f;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.primer_slide_fragment, container, false);
    ...
    public void onClickNext() {
        listener.onClickSiguienteSlide(Constantes.PRIMER_SLIDE);
    }
