...
public class SegundoFragment extends Fragment{
    private static String TAG = SegundoFragment.class.getSimpleName();
    ...
    public static SegundoFragment newInstance() {
        SegundoFragment f = new SegundoFragment();
        Bundle b = new Bundle();
        f.setArguments(b);
        return f;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.segundo_slide_fragment, container, false);
    ...
    public void onClickNext() {
        listener.onClickSiguienteSlide(Constantes.SEGUNDO_SLIDE);
    }
